              ...
              <tbody>
                ...
                ?>
                    <tr>
					  ...
					  <td>
                        <a href="remove-bookings-item.php?id=<?php echo $booking_item['booking_id']; ?>" class="tx-inverse text-danger tx-12 tx-medium d-block text-center" onclick="return confirm('Are you sure want to remove?');">Delete</a>
                      </td>
                    </tr>
                    <?php
						}

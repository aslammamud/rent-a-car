              ...
              <tbody>
                ...
                <?php				
                    ...
                    <tr>
					  ...
					  <td>
                        <a href="remove-services-item.php?id=<?php echo $service_item['service_id']; ?>" class="tx-inverse text-danger tx-12 tx-medium d-block text-center" onclick="return confirm('Are you sure want to remove?');">Delete</a>
                      </td>
                    </tr>
                    <?php
						}

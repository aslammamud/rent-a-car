...
<div id="content">
   <section class="padding-top-20 padding-bottom-60">
      <div class="container ">
         ...
         <span> <i class=""></i>	</span> 
         <p class=" row1 m-b-50 h4 ">
            Welcome to the Hasib Travels website operated by Hasib Travels Bangladesh Ltd. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy. 
         </p>
         <span> <i class=""></i>  </span> 
         <p class=" row1 m-b-50 h4 ">
         ...
         <div class="heading">
		 <br><br>
            <h1>1. Data that we collect</h1>
            <hr>
         </div>
         <span> <i class=""></i></span>
         <p class=" row5 m-b-50 h4 ">
         ...
         <div class="heading">
			<br><br>
            <h1>2. Other uses of your Personal Information</h1>
            <hr>
         </div>
         <span> <i class=""></i></span>
         <p class=" row5 m-b-50 h4 ">
         ...
         <div class="heading">
		 <br><br>
            <h1>4. Third Parties and Links</h1>
            <hr>
         </div>
         <span> <i class=""></i></span>
         <p class=" row5 m-b-50 h4 ">
